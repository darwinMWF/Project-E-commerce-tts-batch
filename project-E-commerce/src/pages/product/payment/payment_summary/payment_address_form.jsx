...
import ProductBill from "../../cart/cart_bill";
...
const PaymentForm = ({ cities }) => {
  ...
  return (
    <>
     <div className="container d-flex justify-content-center align-items-center  my-5 address-main ">
     {
      !IsAddressAdded.flag ? (
        <form
          className="row g-3 payment-form shadow border rounded-3"
