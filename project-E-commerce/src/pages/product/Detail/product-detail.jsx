...
const Productdetail = () => {
  ...
  return (
    <>
      <Header />
      <div className="container d-flex align-items-center justify-content-center p-5 p-sm-0" style={{"height":size.width > 700?"100vh":"auto"}}>
            ...
            <div className="row d-flex align-items-center justify-content-center g-0 h-100 ">
              <div className="col-md-6 text-center">
                {size.width > 700 ? (
                  ...
                  <img
                    src={storeData.selectedProduct.image}
                    className=" img-fluid rounded-start object-fir-cover"
                    alt="product-image"
                    height={"200px"}
                    width={"200px"}
                  />
